      ...
      <>
        <div className="lg:flex lg:gap-2">
          <div className="lg:w-6/12 mb-3">
            <div className="w-100">
              ...
              {/* {errors.first_name && <p className="text-red-600 text-xs font-semibold mt-1">{errors.first_name}</p>} */}
            </div>
          </div>
          <div className="lg:w-6/12 mb-3">
            <div className="w-100">
              ...
              {/* {errors.last_name && <p className="text-red-600 text-xs font-semibold mt-1">{errors.last_name}</p>} */}
            </div>
          </div>
        </div>
        ...
        <div className="lg:w-12/12 mb-3">
          <div className="w-100">
            ...
            {apiError && <p className="text-red-600 text-xs font-semibold mt-1">{apiError}</p>} */}
          </div>
        </div>
        ...
        <div className="lg:flex lg:gap-2">
          ...
          <div className="lg:w-6/12 mb-3">
            <div className="w-100">
              ...
              {/* {errors.confirmPassword && <p className="text-red-600 text-xs font-semibold mt-1">{errors.confirmPassword}</p>} */}
            </div>
          </div>
        </div>
        ...
        <button
          type="submit"
          className="btn btn-default btn-signup w-full bg-pink-500 text-white hover:bg-pink-600 capitalize text-base"
        >
          Continue
        </button>
      </>
